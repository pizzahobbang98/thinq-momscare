...
const DEFAULT_STANDBY: StandbyDisplayState = {
  ...
  modeLabel: '기본 모드',
  youtubeId: 'hso3oR8PJss',
  youtubeEndSeconds: 300,
  image: null,
...
const PREGNANT_STANDBY: Record<string, StandbyDisplayState> = {
  ...
  housework_care: {
    ...
    active: true,
    title: '가사 케어 타이머',
    subtitle: '몸을 아끼며 정리할 수 있도록 짧은 리듬을 재생해요',
    modeLabel: '가사 케어',
    youtubeId: '1tCxGMxdeik',
    youtubeEndSeconds: 300,
    image: null,

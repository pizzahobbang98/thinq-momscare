...
export const koText = {
  ...
  routines: {
    nausea_food: {
      ...
      speech:
        "자극적인 입덧 메뉴는 제외하고, 오늘 먹기 편한 식사 환경으로 바꿔볼게요.\n공기청정기를 터보로 돌리고 주방 공기를 빠르게 순환시켜 냄새 부담을 줄여줄게요.",
    ...
    sleep_care: {
      ...
      speech:
        "잠들기 편한 밤 환경으로 바꿔볼게요.\n직접 바람과 화면 자극을 줄이고 공기청정기를 수면 모드로 맞춰, 잘 깨지 않는 밤을 준비할게요.",
    ...
    housework_care: {
      ...
      speech:
        "무리하지 않는 집안일 환경으로 바꿔볼게요.\n세탁물 케어를 유지하고 집안일 알림을 부드럽게 정리해, 지금 바로 움직이지 않아도 되게 도울게요.",
    ...
    destination_forest: {
      ...
      speech:
        "숲속처럼 고요한 휴식 공간으로 바꿔볼게요.\n숲 화면과 차분한 빛, 부드러운 공기 흐름으로 마음이 가라앉도록 도울게요.",
    ...
    destination_ocean: {
      ...
      trigger: "오늘은 어디론가 가고 싶어.",
      speech:
        "바다 휴양지처럼 쉬는 공간으로 바꿔볼게요.\n바다 화면과 시원한 공기 흐름을 맞춰 답답한 기분을 덜고 잠시 쉬어갈 시간을 만들게요.",
    ...
    destination_city: {
      ...
      trigger: "오늘은 어디론가 가고 싶어.",
      speech:
        "도심 라운지처럼 차분한 공간으로 바꿔볼게요.\n도시 화면과 은은한 빛, 안정적인 공기 흐름으로 편안히 쉬는 시간을 만들게요.",

...
const UNKNOWN_REPLY =
  '제가 정확히 이해하지 못했어요. 입덧, 수면, 가사, 바다, 숲, 도시, 전구, 공기청정기처럼 생활 케어와 집 안 환경 제어 중에서 다시 말씀해 주세요.'
...
function normalizeText(text: string) {
  let normalized = text
    ...
    .replace(/공기정정기/g, '공기청정기')
    .replace(/공기청전기/g, '공기청정기')
    .replace(/공기청증기/g, '공기청정기')
    .replace(/공기청정지/g, '공기청정기')
    .replace(/공기청정길/g, '공기청정기')
    .replace(/굳모닝/g, '굿모닝')
    .replace(/굿모닝이야/g, '굿모닝')
    .replace(/군모닝/g, '굿모닝')
    .replace(/냄세/g, '냄새')
